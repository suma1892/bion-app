...
export default class Carousel extends Component {
  ...
  renderPageIndicator() {
    ...
    this.children.forEach((child, i) => {
      style = i === activePage ?
        {color: 'white',  width: 35, height: 10,backgroundColor:'white', borderRadius: 50, overflow: 'hidden'} :
        {color: '#030062', height: 10, aspectRatio: 1, backgroundColor:'#030062', borderRadius: 100, overflow: 'hidden'};
      indicators.push(
        <Text
