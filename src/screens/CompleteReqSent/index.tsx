...
const CompleteReqSent = ({ navigation, route }) => {
        ...
        <View style={{
            ...
            <ScrollView>
                <View style={styles.mainWrapper}>
                    <IcVideoCall />
                    <Text style={styles.fontMax}>{`Your Request\nRequest is Sent!`}</Text>
                    <Text style={styles.fontDesc}>{`Please make sure you have active internet. You’ll be contacted by our customer service via video call on:`}</Text>
...
export default CompleteReqSent;
