    ...
    return (
        <ViewContainer>
            <MainHeader
                ...
                desc={'Please create a password for your new account'}
            ...
            <Text style={styles.fontDesc2}>Password</Text>
            <TextInput
                isPassword={true}
                placeholder={'Enter Password'}
            />
            ...
            <TouchableOpacity
                onPress={() => { navigation.navigate('CreateTransactionPin', { status: status }) }}
                style={styles.button}>
