...
import { IcEmail, Ichelp } from '../../assets/Images';
...
const VerifyAccountEmail = ({ navigation, route }) => {
    ...
    useEffect(() => {
        ...
        if (pin?.length === 6) {
            ...
            if (screen === 'no-info') {
                navigation.navigate('CreateNewPassword', { screen: screen });
                return 0;
            } 
            if (screen === 'Profile') {
    ...
    return (
        <ViewContainer>
            <MainHeader
                title={'Verify E-mail'}
                desc={'Please enter 6-digit code sent to ****tha@gmail.com'}
            ...
            <Text style={styles.fontDenied}>I Can’t Access My E-MaiL</Text>
