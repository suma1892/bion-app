...
import { BgSuccess, BgSuccessFooter, IcArrowTop, IcBionBlue, IcBubleChecklist, IcClose, IcDownload, IcDownloadOrange, IcFavorit, IcHair2, IcShare, IcShareOrange } from '../../assets/Images';
import { black50, black70, dark_blue, primary_blue, primary_orange, primary_red, white } from '../../assets/styles/Colors';
...
const TabkaCreated = ({ navigation }) => {
    ...
    return (
        <ViewContainer showBackgroundImage={false} backgroundColor={dark_blue}>
            ...
            <Text style={styles.fontSuccess}>Tabka is Created!</Text>
            <Text style={styles.font400}>You can view and manage <Text style={styles.font800}>Tabka Hadiah</Text> - 12345676271 in <Text style={styles.font800}>Account {'>'} Others</Text>
                {`\n\nNext autodebet will be done in 11 Aug 2021`}
            </Text>
