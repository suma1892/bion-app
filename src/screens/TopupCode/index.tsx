    ...
    return (
        <ViewContainer>
            ...
            <View style={{
                ...
                <Text css={'8-24'}>Top Up Cash</Text>
                ...
                <View style={styles.withdrawWrapper}>
                    <Text css={'4-12-' + black70}>Top Up Code</Text>
            ...
            <ButtonYellow
                ...
                onPress={()=>navigation.navigate('TopupInstruction')}
            />
            <Text onPress={() => bottomSheetRef2.current.snapToIndex(0)} css={"8-14-" + primary_yellow} style={{ position: 'absolute', bottom: 20, alignSelf: 'center' }}>Cancel Top Up</Text>
            ...
            >
                <View style={{
                    ...
                    />
                    <IcWithdrawMoney />
                    <Text css={'8-24'} >Cancel Top Up Cash?</Text>
                    <Text css={'4-14'}>Your code will be invalidated after cancellation</Text>
