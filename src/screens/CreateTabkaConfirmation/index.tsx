...
const CreateTabkaConfirmation = ({ navigation }) => {
    return (
        <View style={{
            ...
            <ScrollView>
                <View style={{
                    ...
                    <View style={{
                        ...
                        <View style={{ width: '50%' }}>
                            <Text style={[styles.fontHeader, { marginTop: 24 }]}>Monthly Deposit</Text>
                            <Text style={styles.fontDesc}>Rp5.000.000</Text>
                        </View>
...
export default CreateTabkaConfirmation;
