...
const BMSavingsCreated = ({ navigation }) => {
    ...
    return (
        <ViewContainer showBackgroundImage={false} backgroundColor={dark_blue}>
            ...
            <Text style={styles.fontSuccess}>Tabungan Mestika is Created</Text>
            <Text style={styles.font400}>Start saving or do transaction using the new account</Text>
...
export default BMSavingsCreated;
