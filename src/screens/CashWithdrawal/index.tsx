    ...
    return (
        <ViewContainer showBackgroundImage={false} backgroundColor={white}>
            <MainHeader
                ...
                desc={'Withdraw via Bank Mestika teller by using QR code'}
            />
            <View style={{
                position: 'absolute',
                top: '-40%',
            ...
            <Text css={"4-12"} style={{marginTop: 42}}>Withdraw from</Text>
            ...
            <ButtonYellow
                ...
                onPress={() => navigation.navigate('TransferConfirmation', {screen: 'WithdrawalCode'})}
            />
        </ViewContainer>
    );
};
