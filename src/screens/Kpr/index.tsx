                    ...
                    </View>
                    {
                        <>
                            ...
                            <View style={{
                                ...
                                <Text style={styles.fontBalance}>OUTSTANDING BALANCE</Text>
                                <Text style={styles.fontRp}>Rp15.000.000</Text>
                                <Text style={styles.fontRek}>KPR Primer 73849351234</Text>
                            </View>
                            ...
                            <View style={{
                                ...
                                <Text css='4-12' style={{
                                    alignSelf: 'flex-end'
                                }}>of  <Text css='7-12'>Rp700.000.000</Text> paid</Text>
                            </View>
...

                        {
                            <View>
                                ...
                                <View style={{
                                    ...
                                    <View>
                                        <Text style={[styles.fontTitle, {}]}>Plafond</Text>
                                ...
                                <View style={{
                                    ...
                                    <View style={{ width: '50%' }}>
                                        <Text style={[styles.fontTitle, {}]}>Next Monthly Installment</Text>
                                        <Text style={[styles.fontTitle2, { fontFamily: nunito400 }]}>Rp15.000.000</Text>
                                    </View>

                                    <View>
                                        <Text style={[styles.fontTitle, {}]}>Payment Due Date</Text>
                                        <Text style={[styles.fontTitle2, { fontFamily: nunito400 }]}>11 Jul 2021</Text>
                                    </View>
                                </View>
                                ...
                                <View style={{
                                    ...
                                    <View>
                                        <Text style={[styles.fontTitle, {}]}>Number of Payment Done</Text>
                                        <Text style={[styles.fontTitle2, { fontFamily: nunito400 }]}>10 months</Text>
                                    </View>
                                </View>
