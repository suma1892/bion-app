...
const DepositoCreated = ({ navigation }) => {
    ...
    return (
        <ViewContainer showBackgroundImage={false} backgroundColor={dark_blue}>
            ...
            <Text style={styles.fontSuccess}>bion Deposito is Created</Text>
            <Text style={styles.font400}>You can view and manage <Text style={styles.font800}>bion Deposito - 123412341 </Text><Text style={styles.font800}>Account {'>'} Others</Text>
            </Text>
...
export default DepositoCreated;
