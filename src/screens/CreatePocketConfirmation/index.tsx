...
const CreatePocketConfirmation = ({ navigation }) => {
    return (
        <View style={{
            ...
            <ScrollView>
                <View style={{
                    ...
                    <Text style={[styles.fontHeader, { marginVertical: 14 }]}>From</Text>
                    ...
                    <Text style={[styles.fontHeader, { marginTop: 72 }]}>Transaction Type</Text>
                    <Text style={styles.fontDesc}>Create bion Pocket</Text>
                ...
                <View style={{
                    ...
                    <ButtonYellow
                        ...
                        onPress={() => navigation.navigate('TransactionPin', {screen: 'TabkaCreated'})}
                    />
                </View>
            </ScrollView>
        </View>
...
export default CreatePocketConfirmation;
