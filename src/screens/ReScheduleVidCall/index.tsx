...
const ReScheduleVidCall = ({ navigation }) => {
        ...
        <View style={{
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <Text style={styles.fontInfo}>Re-schedule Video Call</Text>
                    <Text style={styles.fontDesc}>{`Please choose available time to receive video call verification from our customer service`}</Text>
                </View>
                ...
                <Text style={[styles.fontTitle, { marginTop: 30, marginBottom: 10 }]}>TIME</Text>
            ...
            <TouchableOpacity
                ...
                style={styles.button}>
                <Text style={styles.fontChoose}>Save Schedule</Text>
            </TouchableOpacity>
        </View>
    );
};

export default ReScheduleVidCall;
