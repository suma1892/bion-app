...
import { BgSuccess, BgSuccessFooter, IcArrowRight, IcArrowRightOrange2, IcArrowTop, IcBionBlue, IcBubleChecklist, IcClose, IcDownload, IcDownloadOrange, IcFavorit, IcHair2, IcShare, IcShareOrange } from '../../assets/Images';
...
const StatusSuccessful = ({ navigation }) => {
