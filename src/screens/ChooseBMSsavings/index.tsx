...
const ChooseBMSsavings = ({ navigation }) => {
    ...
    function _renderItem({ item, index }) {
        return (
            <Image
                source={require('../../assets/Images/File/sample-card-mestika.png')}
                style={{
                    height: 188,
                    width: 288
                }}
        ...
        <View style={{
            ...
            <ScrollView>
                <View style={{
                    ...
                    <Text style={styles.fontDesc2}>Tabungan Mestika</Text>
                    <Text style={[styles.fontTitle, { textAlign: 'center' }]}>{`Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed to elusmod tempor. What you will get from this account:`}</Text>
                </View>
                <View style={{
                    marginTop: 32,
                    height: 360,
                    ...
                    <View style={{
                        ...
                        <View style={styles.rowWrapper}>
                            <Text style={styles.fontRowHeader}>Min. Balance</Text>
                            <Text style={[styles.fontRowHeader, { fontFamily: nunito700 }]}>Rp11.000</Text>
                        </View>
                        <View style={styles.rowWrapper}>
                            <Text style={styles.fontRowHeader}>Monthly Fee</Text>
                            <Text style={[styles.fontRowHeader, { fontFamily: nunito700 }]}>Rp11.000</Text>
                        </View>
                    </View>
                    <ButtonYellow
                        ...
                        onPress={() => navigation.navigate('CreateBmSavings')}
                    />
                </View>
            </ScrollView>
        </View>
...
export default ChooseBMSsavings;
